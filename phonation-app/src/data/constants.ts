...
export const SCRIPT_LARYNX: Step[] = [
    ...
    },
    {
        ...
        content: "\"The <Nerves>recurrent laryngeal nerves</Nerves> (τό παλινδρομοῦν νεῦρον) are described as two small nerves ascending from below... Galen names it 'unjust' (ἄδικον) that this nerve would not reach directly from the brain, and he praises nature for constructing it the way it is.\"",
        media: "image",
        mediaUrl: "reference/glottis_illustration(1).png"
    },
    {
