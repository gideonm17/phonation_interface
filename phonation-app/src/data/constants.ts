...
export const GLOSSARY: Record<string, GlossaryEntry> = {
    ...
    "Glottis": {
        term: "Glōttis",
        def: "Described by Galen as 'a certain body' (τι σῶμα) unlike any other part of the body in substance or structure — 'the first and most proper organ of the voice' (UP 7.13). Located in the inner cavity of the larynx, it consists of two paired membranous lips (left and right) that meet to close the passage, with a ventricle beneath each part that stores excess air during phonation. Named after the mouthpiece (glōttis) of the aulos, though Galen insists the aulos mouthpiece imitates the glōttis, not vice versa."
    },
    "Arytenoid": {
        term: "Arytaina",
    ...
    "Muscles": {
        ...
        def: "The twelve intrinsic muscles of the larynx, distinct from the eight extrinsic muscles. The thyroarytenoid muscles are most crucial: connecting to the glōttis from the thyroid cartilage, they close the passage during phonation — Galen states nature 'demonstrated superb skill' in constructing them (AA 11). The cricoarytenoid muscles open the glottis; the cricothyroid muscles (four in loud-voiced animals, including humans) move the thyroid cartilage. All twelve are controlled by the recurrent laryngeal nerve, except the cricothyroids which are governed by the superior laryngeal nerve."
    },
    "Nerves": {
        term: "Palindromoun",
    ...
    "Whirlpool": {
        term: "Iliggos",
        def: "Galen's term for the spinning motion of air inside the laryngeal ventricles during phonation. When the glōttis narrows, excess ἐκφύσησις is deflected sideways into the cavities beneath the glottic lips, producing what Galen calls 'some kind of a whirlpool experience' (οἷον ἴλιγγόν τινα παθὸν, UP 7.13). This keeps the air in continuous motion within the ventricles without pressing outward on the closed passage, allowing the glōttis to remain narrowed and the phonatory strike to proceed."
    }
};
