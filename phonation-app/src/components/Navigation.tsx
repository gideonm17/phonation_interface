...
export const Navigation = () => {
    const { activeSection, setActiveSection, setShowBibliography } = useAppStore();
    ...
    return (
        <nav className="bg-white border-r border-ink/10 flex flex-col items-center py-8 gap-8 w-16 md:w-20 shrink-0 z-50 shadow-lg">
            ...
            <button
                ...
                className="p-3 rounded-xl transition-all duration-300 text-black/40 hover:bg-black/5 hover:text-galen-red mt-auto"
                title="Bibliography"
            >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
